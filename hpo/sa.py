...
def main():
    ...
    ap.add_argument("--start-temp", type=float, default=1.0, dest="start_temp")
    ap.add_argument("--cool", type=float, default=0.99)
    ...
    algo = SimulatedAnnealing(
        delta=args.delta,
        starting_temperature=args.start_temp,
        delta_temperature=args.cool,
        seed=args.seed,
    )
