...
Следниве CSV фајлови се креирани за понатамошна анализа:

1. **best_models_Half_Life_Obach.csv** - Топ 20 модели за Half_Life_Obach
2. **best_models_Clearance_Hepatocyte_AZ.csv** - Топ 20 модели за Clearance_Hepatocyte_AZ
3. **best_models_Clearance_Microsome_AZ.csv** - Топ 20 модели за Clearance_Microsome_AZ
4. **SUMMARY_BEST_MODELS.csv** - Резиме на најдобри модели за сите datasets
5. **MODEL_STATISTICS.csv** - Статистички преглед по модел и dataset
6. **HYPERPARAMETER_ANALYSIS.csv** - Анализа на влијание на хиперпараметри

Локација: `C:\Users\Martin.DESKTOP-J36C0SU\Desktop\MANU-master\`
