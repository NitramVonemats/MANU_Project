...
def main():
    ...
    print(f"\nLoaded {len(results_df)} HPO results")
    print(f"Datasets: {results_df['Dataset'].unique().tolist()}")
    print(f"Algorithms: {results_df['Algorithm'].unique().tolist()}")

    # Create all visualizations
    plot_algorithm_performance(results_df)
    plot_best_hyperparameters(results_df)
    plot_winner_analysis(results_df)
